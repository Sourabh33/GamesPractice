...
public class Bullet1 extends GameObject implements BasePlayer {

    private Texture texture;
    private int level;

    public Bullet1(double x, double y, Texture texture, Game game) {
        super(x, y);
        this.texture = texture;
        level = game.getLevel();
    }

    public Bullet1(double x, double y) {
        super(x, y);
    }
